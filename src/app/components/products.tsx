        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative w-full h-64">
              <Image   width={200} height={200} src="/card-cover-5.jpg" alt="Hero 1" layout="fill" objectFit="cover" />
            </div>
            <div className="relative w-full h-64">
              <Image   width={200} height={200} src="/myapp/src/card-cover-6.jpg" alt="Hero 2" layout="fill" objectFit="cover" />
            </div>
            <div className="relative w-full h-64">
              <Image  width={200} height={200} src="/myapp/src/card-cover-7-1.jpg" alt="Hero 3" layout="fill" objectFit="cover" />
            </div>
            <div className="relative w-full h-64">
              <Image width={200} height={200} src="/myapp/src/card-cover-7-2.jpg" alt="Hero 4" layout="fill" objectFit="cover" />
            </div>
          </div>
        </div>
      </section>
